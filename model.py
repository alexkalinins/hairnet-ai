...
MODEL_SAVE = [MODEL_DIR+'ix0-e28.pt', MODEL_DIR+'ix1-e36.pt', MODEL_DIR+'ix2-e39.pt', MODEL_DIR+'ix3-e69.pt', MODEL_DIR+'ix4-e34.pt', MODEL_DIR+'ix5-e11.pt', MODEL_DIR+'ix6-e69.pt',MODEL_DIR+'ix7-e36.pt', MODEL_DIR+'ix8-e69.pt']  # would be a list of save files for all the models
