...
class HairNet5(nn.Module):
    def __init__(self):
        super().__init__()
        # conv layers
        self.conv1 = nn.Conv2d(1, 32, 11, 1)
        self.conv2 = nn.Conv2d(32, 64, 11, 1)
        self.conv3 = nn.Conv2d(64, 128, 11, 1)
        self.conv4 = nn.Conv2d(128, 128, 11, 1)
        ...
        self.fc5 = nn.Linear(128, 9)  # we need 9 parameters
